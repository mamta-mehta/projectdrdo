...
<html>
<head>
	<title>sattalite call application</title>
...
<body>
	<div class="container">
		<h2 class="text-center" style="margin-top: 5px; padding-top: 0;">D.R.D.O SECURE SATALLITE INFORMATION TRANSMISSION</h2>
		<hr>
		<div class="row">
			<div class="col-md-4">
				<?php 
			...
			<div class="col-md-8">
				<div id="messages">
					<table id="chats" class="table table-striped">
					  <thead>
					    <tr>
					      <th colspan="4" scope="col"><strong>MESSAGE HISTORY</strong></th>
					    </tr>
					  </thead>
					  <tbody>
					   <?php
